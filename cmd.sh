...
# model version 3
python -u train.py --version 3 --batch-size 18 --optim adam --lr 1e-4 --lr-decay 0.1 --steps 30,50 --epoches 70 --gpu 0,1 --backbone resnet50 --freq 100 --prefix test --num-channel 256
