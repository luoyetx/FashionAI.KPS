...
# model version 2
python -u train.py --version 2 --batch-size 32 --optim sgd --lr 1e-4 --lr-decay 0.1 --steps 15,30 --epoches 40 --gpu 0,1 --backbone resnet50 --freq 50 --prefix test  --num-stage 3 --num-channel 128
