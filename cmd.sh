...
# model version 3
python -u train.py --version 3 --batch-size 6 --optim adam --lr 1e-4 --lr-decay 0.1 --steps 30,50 --epoches 70 --gpu 0,1 --backbone resnet50 --freq 300 --prefix test  --num-stage 3 --num-channel 256
