# single v3
python -u predict.py --model ./output/final/v3/V3.fine.59.scale3.ohkm-resnet50-C256-BS16-adam-0027.params --version 3 --scale 3 --num-worker 3 --gpu 0 --multi-scale --type test --prefix single.v3
